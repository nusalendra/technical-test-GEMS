<x-app-layout>
    @section('title', 'Tambah Posisi Perusahaan')
    <div class="py-12">
        <div class="max-w-5xl rounded-lg mx-auto sm:px-6 lg:px-8 bg-white shadow-md mb-4">
            <div class="max-w-4xl mx-auto py-6">
                <h5 class="py-1 mb-4 text-black font-semibold text-xl">Tambah Posisi Perusahaan</h5>
                <form action="/posisi" method="POST" enctype="multipart/form-data" id="addKaryawanForm">
                    @csrf
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama" id="nama"
                            ...
                            placeholder="Masukkan Nama Posisi" required value="{{ old('nama') }}">
                    </div>
